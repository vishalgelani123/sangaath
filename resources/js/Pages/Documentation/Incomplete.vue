                ...
                <div class="max-w-sm">
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <TextInput v-model="search_query" v-on:keyup="search()" v-on:change="search()"
                                   autocomplete="off" id="search" type="text" placeholder="Search Incomplete Forms"
            ...
            <div class="mt-6">
                <div v-if="all_forms.length == 0" class="mt-20 inline-block min-w-full align-middle">
                    <div class="flex items-center flex-col">
                        ...
                        <h3 class="mt-2 text-lg font-semibold text-gray-900">No Incomplete documents</h3>
                        <p class="mt-1 text-sm text-gray-500">You have no incomplete documents to work upon.</p>
                    </div>
                </div>
                        ...
                        <tr v-for="form in display_forms" :key="form.id">
                            ...
                            <td class="whitespace-nowrap px-6 py-3 text-right text-sm font-medium">
                                <a @click="startApplication(form)" href="javascript:void(0)"
                                   class="text-blue-600 hover:text-blue-900">Start Application</a>
                            </td>
                            <td class="whitespace-nowrap px-6 py-3 text-right text-sm font-medium">
    ...
    export default {
        ...
        methods: {
            ...
            deleteProcess() {
                ...
                var vue = this;
                axios.post('/documentation/incomplete/delete', formData).then(function (response) {
