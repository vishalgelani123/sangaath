            ...
            <div class="flex items-center justify-between">
				<div class="w-full border-b border-gray-200">
					<nav class="-mb-px flex" aria-label="Tabs">
						...
						<Link href="/followup/benefit-received" :class="['border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300', 'w-1/3 py-4 px-1 text-center border-b-2 font-medium text-sm']" aria-current="page">Benefit Received</Link>
						<Link :class="['border-blue-500 text-blue-600', 'w-1/3 py-4 px-1 text-center border-b-2 font-semibold text-sm']" aria-current="page">Rejected</Link>
					</nav>
				</div>
    ...
    export default {
        ...
        methods: {
			...
			loadMoreData(is_first_search = false) {
				...
				axios.get(`/followup/rejected?is_ajax=1&skip=${skipping_rows}${search_query ?? ''}`).then(function (response) {
