                    ...
                    <li class="relative col-span-1 flex rounded-md shadow-sm">
                        ...
                        <div
                            ...
                            <div class="flex-1 truncate px-4 py-1.5 text-sm">
                                <a href="#"
                                   class="font-semibold text-lg text-gray-900 hover:text-gray-600">{{ overview.sites
                                    }}</a>
                                <p class="-mt-1 text-gray-500 text-sm">Sites</p>
                            </div>
                        </div>
                    </li>
                ...
                charts: {
                    followup: {
                        ...
                        options: {
                            ...
                            xaxis: {
                                type: 'string',
                                categories: this.followup["site_names"],
                            },
                            legend: {
                                position: 'top',
                                offsetY: 0
